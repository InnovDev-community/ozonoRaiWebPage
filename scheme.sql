...
CREATE TABLE products(
 ...
 ("Modelo Gota en Acero Inoxidable", "<div>Descripción <h1>1</h1></div>", "modelo_gota.png", "<div>video <h1>1</h1></div>"),
 ("Modelo Alargado en Acero Inoxidable", "<div>Descripción <h1>2</h1></div>", "modelo_alargado.png", "<div>video <h1>2</h1></div>"),
 ("Modelo Mini en Acrílico - ABS", "<div>Descripción <h1>3</h1></div>", "modelo_mini.png", "<div>video <h1>3</h1></div>"),
