            ...
            <figure class="slider">
                <figure class="inicio__slide">
                    ...
                    <div class="slide__descripcion">
                        <p class="slide-des__title titulo-1">elimina gérmenes <span>y residuos químicos<span></p>
                        <p class="slide-des__contenido contenido-1">Ideal para la limpieza de frutas y verduras, carnes y pescados manteniendo por más tiempo
                            su frescura</p>
                    </div>
                </figure>           
                <figure class="inicio__slide">
                    ...
                    <div class="slide__descripcion">
                        <p class="slide-des__title titulo-2">uso <span>medicinal</span></p>
                        <p class="slide-des__contenido contenido-2">El agua ozonizada concentrada representa una gran ayuda en el tratamiento de gastritis, ya que reduce la acidez estomacal y tonifica las paredes estomacales por su defecto cicatrizante.
                        </p>
                    </div>
                </figure>           
                <figure class="inicio__slide">
                    <div class="contenedor-slider">
                        ...
                        <div class="slide__descripcion desc-1">
                            <p class="slide-des__title">salud & <span>bienestar</span></p>
                            <p class="slide-des__contenido">El ozono es el desinfectante</p>
                            <p class="slide-des__contenido">natural más eficaz que se conoce</p>
                        </div>
